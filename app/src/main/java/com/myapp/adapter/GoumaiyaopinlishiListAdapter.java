...
import com.myapp.activity.YsYuyuelishiDetailActivity;
...
public class GoumaiyaopinlishiListAdapter extends BaseAdapter {
	...
	public GoumaiyaopinlishiListAdapter(Context context,
			List<Goumaiyaoping> mData) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(
					R.layout.activity_ys_yuyuelishi_yaoping_list_item, null);

			FinalActivity.initInjectedView(this, convertView);

			holder.yaopingid = (TextView) convertView
					.findViewById(R.id.yaopingid);
		...
		holder.shuliang.setText(String.valueOf(mData.get(position)
				.getGoumaishuliang()));

		holder.zongjia.setText(String.valueOf((mData.get(position).getDanjia())
				* mData.get(position).getGoumaishuliang()));
